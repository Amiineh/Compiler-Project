...
['@hide_upper_scopes', 'int', '@push_stack', 'ID', '@push_stack', '[', 'NUM', '@push_stack', '@check_array_size',']', '@define_array', '#allocate_array', '@unhide_upper_scopes',';'],
    #TODO: function
['@hide_upper_scopes', 'int', '@push_stack', 'ID', '@store_fun', '@open_scope', '(', 'params', ')', '@unhide_upper_scopes', '#set_fun_adrs', 'compound_stmt', '@close_scope', '#jp_fun'],
['@hide_upper_scopes', 'void','@push_stack', 'ID', '@store_fun', '@open_scope', '(', 'params', ')', '@unhide_upper_scopes', '#set_fun_adrs', 'compound_stmt', '@close_scope', '#jp_fun'],
['param_list'],
['void'],
['param_list',',','param'],
['param'],
['int', '@push_stack', 'ID', '@define_var', '@store_fun_arg'],
...
['return', ';', '@assert_void_fun_return', '@return_void_fun'],#TODO: function
['return', 'expression', ';', '@assert_non_void_fun_return', '@return_value_fun'],
['var', '=', 'expression', '@check_assign_type', '#assign'],
['simple_expression'],
['ID', '@push_variable'],
